...
```markdown
---
'@nl-design-system-community/<package>': major
---
...
- `"@nl-design-system-community/<package>": major` voor breaking changes
- `"@nl-design-system-community/<package>": minor` voor nieuwe features
- `"@nl-design-system-community/<package>": patch` voor bug fixes
