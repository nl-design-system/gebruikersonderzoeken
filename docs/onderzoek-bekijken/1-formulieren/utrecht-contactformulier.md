---
title: Vindbaarheid en gebruikersvriendelijkheid contactformulier gemeente Utrecht
hide_title: true
hide_table_of_contents: false
sidebar_label: Vindbaarheid en gebruikersvriendelijkheid contactformulier gemeente Utrecht
pagination_label: Vindbaarheid en gebruikersvriendelijkheid contactformulier gemeente Utrecht
description: Kunnen de inwoners met gemak en vertrouwen het contactformulier invullen?
summary: Inwoners kunnen het ontworpen contactformulier met gemak invullen, maar de nabijheid tussen het contactformulier en het klanttevredenheidsonderzoek zorgt voor ruis.
keywords:
  - onderzoek
  - notificaties
  - notificatie
...
![Screenshot van het contactformulier in het prototype](https://raw.githubusercontent.com/nl-design-system/gebruikersonderzoeken/assets/utrecht-contactformulier__screenshot-contactformulier.png)
...
1. Vindt de inwoner de plek waar hij de vraag kan stellen op de pagina?
2. Kan de inwoner gemakkelijk (eenvoudig, snel, gebruikersvriendelijk) de vraag stellen?
3. Draagt het contactformulier bij aan het vertrouwen van de inwoner dat deze reactie krijgt van de gemeente?
