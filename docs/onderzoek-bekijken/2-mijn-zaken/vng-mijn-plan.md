---
title: Rapportage MijnPlan
hide_title: true
hide_table_of_contents: false
sidebar_label: Rapportage MijnPlan
sidebar_position: 2
pagination_label: Rapportage MijnPlan
description: Service Design-onderzoek naar hoe een ontwikkelplan in het sociaal domein gebruiksvriendelijk toegankelijk kan worden gemaakt in de MijnOmgeving, met focus op doelen, taken, documenten en samenwerking met begeleiders.
summary: MijnPlan wordt door inwoners positief ontvangen als een centrale, overzichtelijke plek voor afspraken, doelen en taken. De iteraties hebben de navigatie, taakafronding en bevestiging verbeterd. Tegelijk laat het onderzoek zien dat goede introductie door medewerkers essentieel blijft, dat open doelen zonder taken nog verwarring oproepen en dat het terugvinden van documenten verdere verbetering vraagt.
keywords:
  - onderzoek
  - mijnomgeving
  - mijn plan
...
1. **Plannen gericht op het oplossen van de acute vraag of het acute probleem**  
   Deze plannen worden aangestuurd door wet- en regelgeving en worden opgestart in het begin van de dienstverlening.  
   Ter illustratie: binnen FH is de acute vraag: _“Hoe kom ik tot een oplossing voor mijn schulden?”_

2. **Plannen gericht op duurzame uitstroom**  
   Deze plannen richten zich op de fase nadat het acute probleem is opgelost.  
   Binnen FH is dan de vraag bijvoorbeeld: _“Hoe kan ik schuldenvrij blijven?”_
...
**Doelen zonder taak**
Er ontstaat hiermee een situatie waarin doelen open kunnen staan zonder openstaande taken. Dit was in de tweede test nog niet duidelijk genoeg. Daarom is dit extra tekstueel toegelicht.

##### Taak afronden flows

We onderscheiden drie toepassingen van taken:

1. **Binnen portaal taak afronden**  
   Eén afgebakende actie binnen MijnGemeente.

2. **Binnen portaal afronden takenreeks, gelinkt aan een voorziening**  
   Een taak bestaande uit meerdere opeenvolgende stappen.

3. **Buiten portaal aanvragen**  
...
1. Analyse processen en visie FH; interviews met experts van FH vanuit beleid en operatie.
2. Analyse van uitgevoerde klantonderzoeken en klantreizen.
3. Analyse van plannen die breed in het sociaal domein worden gebruikt.
4. Interviews met experts van andere gemeenten, overheid en NLDS.

### Fase 2 — Prototype en test

1. Eerste ontwerpen gemaakt op basis van output uit fase 1.
2. Toetsing van prototype onder medewerkers FH.
3. Gebruikerstesten met inwoners in twee rondes.
4. Gebruikerstesten met collega’s via Maze.
