---
title: Opvang en huisvesting van kwetsbare doelgroepen
hide_title: true
hide_table_of_contents: false
sidebar_label: Opvang en huisvesting van kwetsbare doelgroepen
pagination_label: Opvang en huisvesting van kwetsbare doelgroepen
description: Kwalitatief onderzoek naar de wensen en behoeften van inwoners van Den Haag ten aanzien van communicatie en sociale interactie rondom opvang en huisvesting van kwetsbare doelgroepen.
summary: Op basis van de inzichten uit dit onderzoek wordt geadviseerd om volgens een tijdlijn te communiceren richting omwonenden van een locatie of deze omwonenden de mogelijkheid te bieden om contact met de gemeente te hebben. Per moment wordt aangegeven waarover volgens inwoners communicatie is gewenst en in welke vorm.
keywords:
  - opvang
  - huisvesting
...
- Men wil al vóórdat een locatie vaststaat weten dat erover gepraat wordt en input kunnen geven over locaties en aandachtspunten in de eigen wijk.
